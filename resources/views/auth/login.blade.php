                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login') }}">
                                      @csrf
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="username" id="username" aria-describedby="username" placeholder="Enter Username... " value="{{old('username')}}" required autofocus>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center"> <a class="small" href="{{url('register')}}">Register!</a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
